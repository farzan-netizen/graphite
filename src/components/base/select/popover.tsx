...
export const Popover = (props: PopoverProps) => {
  return (
    <AriaPopover
      ...
      className={state =>
        cx(
          'scrollbar-thin bg-primary ring-secondary_alt max-h-64! w-(--trigger-width) overflow-x-hidden overflow-y-auto rounded-lg py-1 shadow-lg ring-1 outline-hidden will-change-transform',
