...
const styles = sortCx({
  common: {
    root: [
      'group relative inline-flex h-max cursor-pointer items-center justify-center whitespace-nowrap outline-brand before:absolute focus-visible:outline-2 focus-visible:outline-offset-2',
  ...
  colors: {
    primary: {
      root: [
        'bg-brand-solid text-brand-solid shadow-xs-skeumorphic ring-1 ring-transparent ring-inset hover:bg-brand-solid_hover data-loading:bg-brand-solid_hover',
        // Inner border gradient
        'before:absolute before:inset-px before:border before:border-white/12 before:mask-b-from-0%',
        // Disabled styles
        'disabled:bg-disabled disabled:shadow-xs disabled:ring-disabled_subtle',
        // Icon styles
        '*:data-icon:text-brand-solid hover:*:data-icon:text-brand-solid_hover',
      ].join(' '),
    },
    secondary: {
      root: [
    ...
    'link-color': {
      root: [
        'justify-normal rounded-xs p-0! text-brand-tertiary hover:text-brand-secondary_hover',
        // Inner text underline
        '*:data-text:underline *:data-text:decoration-transparent *:data-text:underline-offset-2 hover:*:data-text:decoration-current',
        // Icon styles
        '*:data-icon:text-fg-quaternary hover:*:data-icon:text-fg-quaternary_hover',
    ...
    'link-brand': {
      root: [
        'justify-normal rounded-xs p-0! text-brand-tertiary',
        // Inner text underline
        '*:data-text:underline *:data-text:decoration-transparent *:data-text:underline-offset-2 hover:*:data-text:decoration-current',
        // Icon styles
        '*:data-icon:text-fg-quaternary hover:*:data-icon:text-fg-quaternary_hover',
...
export const Button = ({
  ...
  return (
    <Component
      ...
      {...props}
      className={cx(
        !disableTransition && 'transition duration-100 ease-linear',
        styles.common.root,
