  ...
  return (
    ...
    >
      ...
      <AriaInput
        ...
        className={cx(
          'text-md text-primary placeholder:text-placeholder autofill:text-primary m-0 w-full bg-transparent ring-0 outline-hidden',
          isDisabled && 'text-disabled cursor-not-allowed',
          sizes[inputSize].root,
          // Context inputClassName comes first to allow override
          context?.inputClassName,
          // Default rounded-lg only if not overridden by context
          !context?.inputClassName && 'rounded-lg autofill:rounded-lg',
          inputClassName,
        )}
      />
...
export const Input = ({
  ...
  const isInvalid = 'isInvalid' in props ? props.isInvalid : false
